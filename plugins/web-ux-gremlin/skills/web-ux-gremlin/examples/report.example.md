...
Evidence:
- .agent/reports/web-ux-gremlin/screenshots/double-submit-confirm.png
- .agent/reports/web-ux-gremlin/traces/double-submit-confirm.zip
...
Evidence:
- .agent/reports/web-ux-gremlin/screenshots/reload-mid-flow.png
...
Evidence:
- .agent/reports/web-ux-gremlin/screenshots/keyboard-only-create.png
...
- Output directory: .agent/reports/web-ux-gremlin
- .agent/reports/web-ux-gremlin/screenshots/double-submit-confirm.png
- .agent/reports/web-ux-gremlin/screenshots/reload-mid-flow.png
- .agent/reports/web-ux-gremlin/screenshots/keyboard-only-create.png
- .agent/reports/web-ux-gremlin/traces/double-submit-confirm.zip
...
- npx playwright test .agent/generated/web-ux-gremlin.spec.ts --grep double-submit-confirm
