...
description: "Deprecated: consolidated into gremlin-report. Use gremlin-report --fail-on <severity> and the README CI guidance for pipeline integration."
...
This skill has been consolidated into `gremlin-report` because CI severity gates and publishable outputs now belong in reporting.

## Replacement

Use gremlin-report --fail-on <severity> and the README CI guidance for pipeline integration.
