...
6. Review generated warnings about unsupported Copilot-only or VS Code-only fields.
7. Report generated files, updated files, validation commands, and residual host limitations.

## Output

- Generated Codex overlay: `.agent-compat/codex/AGENTS.md`.
- Generated Claude overlay: `.agent-compat/claude/custom-instructions.md`.
